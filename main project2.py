...
class BusinessManagementGame:
    ...
    def create_widgets(self):
        ...
        self.invest_button=tk.Button(self.master,text="Invest",command=self.invest)
    ...
    def work(self):
        ...
        if self.income >=self.expenses:
            messagebox.showinfo("congratulation","you have earned money to cover your expenses")
